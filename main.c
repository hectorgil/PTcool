...
double *Pk21,*Pk22,*Pk23,*Pk24,*Pk25,*Pk26,*Pk27,*Pk28,*Pk29,*Pk30,*Pk31,*Pk32,*Pk33,*Pk34,*Pk35,*Pk36,*Pk37,*Pk38,*Pk39,*Pk40,*Pk41;
...
Pk38 = (double*) calloc( imax, sizeof(double));
Pk39 = (double*) calloc( imax, sizeof(double));
Pk40 = (double*) calloc( imax, sizeof(double));
Pk41 = (double*) calloc( imax, sizeof(double));
...
printf("Done with RPT integration of k->%lf on thread %d \n", k, tid);

Pk1[i]=p0;Pk2[i]=p22dd;Pk3[i]=p22do;Pk4[i]=p22oo;Pk5[i]=p33dd;Pk6[i]=p33do;Pk7[i]=p33oo;Pk8[i]=p13d;Pk9[i]=p13o;Pk10[i]=p15d;Pk11[i]=p15o;Pk12[i]=p24dd;Pk13[i]=p24oo;Pk14[i]=p24do1;Pk15[i]=p24do2;
...
Pk16[i]=Pb2_delta;Pk17[i]=Pb2_theta;Pk18[i]=Pbs2_delta;Pk19[i]=Pbs2_theta;Pk20[i]=Pb2s2;Pk21[i]=Pbs22;Pk22[i]=Pb22;Pk23[i]=sigma3;

printf("Done with NLB integration of k->%lf on thread %d\n", k, tid);
...
Pk24[i]=Taruya_A11;Pk25[i]=Taruya_A12;Pk26[i]=Taruya_A22;Pk27[i]=Taruya_A23;Pk28[i]=Taruya_A33;Pk29[i]=Taruya_B1_11;Pk30[i]=Taruya_B1_12;Pk31[i]=Taruya_B1_21;Pk32[i]=Taruya_B1_22;Pk33[i]=Taruya_B2_11;Pk34[i]=Taruya_B2_12;Pk35[i]=Taruya_B2_21;Pk36[i]=Taruya_B2_22;Pk37[i]=Taruya_B3_12;Pk38[i]=Taruya_B3_21;Pk39[i]=Taruya_B3_22;Pk40[i]=Taruya_B4_22;

}

printf("Done with TNS integration of k->%lf on thread %d \n", k, tid);
...
fprintf(f,"%e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e\n",k,Pk1[i],Pk2[i],Pk3[i],Pk4[i],Pk5[i],Pk6[i],Pk7[i],Pk8[i],Pk9[i],Pk10[i],Pk11[i],Pk12[i],Pk13[i],Pk14[i],Pk15[i],Pk16[i],Pk17[i],Pk18[i],Pk19[i],Pk20[i],Pk21[i],Pk22[i],Pk23[i],Pk24[i],Pk25[i],Pk26[i],Pk27[i],Pk28[i],Pk29[i],Pk30[i],Pk31[i],Pk32[i],Pk33[i],Pk34[i],Pk35[i],Pk36[i],Pk37[i],Pk38[i],Pk39[i],Pk40[i],Pk41[0]);
}
fclose(f);
time_fin=time(NULL);
...
free(Pk32);free(Pk33);free(Pk34);free(Pk35);free(Pk36);free(Pk37);free(Pk38);free(Pk39);free(Pk40);free(Pk41);
