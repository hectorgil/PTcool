...
#pragma omp parallel for private(function_parameters,tid,i,k,p0,p22dd,p22do,p22oo,p33dd,p33do,p33oo,p13d,p13o,p15d,p15o,p24dd,p24oo,p24do1,p24do2,Pb2_delta,Pb2_theta,Pbs2_delta,Pbs2_theta,Pb2s2,Pbs22,Pb22,sigma3,Taruya_A11,Taruya_A12,Taruya_A22,Taruya_A23,Taruya_A33,Taruya_B1_11,Taruya_B1_12,Taruya_B1_21,Taruya_B1_22,Taruya_B2_11,Taruya_B2_12,Taruya_B2_21,Taruya_B2_22,Taruya_B3_12,Taruya_B3_21,Taruya_B3_22,Taruya_B4_22,trash) shared(interval,Nlines,klin,Plin,Plin2pi3,imax,kmin,precision_rpt,precision_max,precision_nlb,precision_tns,XMIN33,XMAX33,XMIN22,XMAX22,XMIN13,XMAX13,XMAX22alt,XMIN44,XMAX44,XMIN,XMAX,Pk1,Pk2,Pk3,Pk4,Pk5,Pk6,Pk7,Pk8,Pk9,Pk10,Pk11,Pk12,Pk13,Pk14,Pk15,Pk16,Pk17,Pk18,Pk19,Pk20,Pk21,Pk22,Pk23,Pk24,Pk25,Pk26,Pk27,Pk28,Pk29,Pk30,Pk31,Pk32,Pk33,Pk34,Pk35,Pk36,interval_type,kmin1,kmax1,kmax11)
for(i=0;i<imax;i++)
{
...
fprintf(f,"%e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e %e\n",k,Pk1[i],Pk2[i],Pk3[i],Pk4[i],Pk5[i],Pk6[i],Pk7[i],Pk8[i],Pk9[i],Pk10[i],Pk11[i],Pk12[i],Pk13[i],Pk14[i],Pk15[i],Pk16[i],Pk17[i],Pk18[i],Pk19[i],Pk20[i],Pk21[i],Pk22[i],Pk23[i],Pk24[i],Pk25[i],Pk26[i],Pk27[i],Pk28[i],Pk29[i],Pk30[i],Pk31[i],Pk32[i],Pk33[i],Pk34[i],Pk35[i],Pk36[i]);
}
fclose(f);
time_fin=time(NULL);
...
free(Pk32);free(Pk33);free(Pk34);free(Pk35);free(Pk36);
